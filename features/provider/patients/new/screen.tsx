...
import { careMonitors, insuranceProviders } from "@/lib/mock-data";

import { useCreatePatientModel } from "./hooks";
export default function CreatePatient() {
  const { done, setDone, unassigned } = useCreatePatientModel();
  if (done) {
    return (
      <>
        ...
        <div className="card p-8 text-center max-w-lg mx-auto">
          ...
          <p className="text-sm text-slate-600 mt-2">
            The patient must click the confirmation link and approve compliance monitoring before
            any data becomes visible to your team. Until then they appear with a{" "}
            <span className="badge badge-amber">Pending</span> consent status.
          </p>
