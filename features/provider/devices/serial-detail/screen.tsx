...
import { useDeviceDetailModel } from "./hooks";
export default function DeviceDetail() {
  const { serial, d, assigned, confirmDeact, setConfirmDeact } = useDeviceDetailModel();
  return (
    <>
      <Link
        href="/provider/devices"
        ...
        >
          <div className="card p-6 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-sm text-red-700 mt-2 bg-red-50 rounded-lg p-3">
              All patient associations are lost when a device is deactivated. The record is retained
              for audit purposes.
            </p>
