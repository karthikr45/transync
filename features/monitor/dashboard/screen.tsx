    ...
    <>
      ...
      <div className="card p-4 mb-5 flex items-start gap-3 bg-blue-50 border-blue-100">
        ...
        <div className="text-xs text-blue-900">
          <strong>Authorized Monitor account.</strong> You can only see patients that Homecare
          Providers have explicitly shared with you. All access is logged.
        </div>
      </div>
      ...
      <div className="card p-5 mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <div className="mt-1 text-2xl font-mono font-semibold text-slate-900 tracking-widest">
            MON-7K3-92H
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard
          label="Compliant"
          value={compliant}
          hint={`${Math.round((compliant / consented.length) * 100)}% of cohort`}
          tone="good"
      ...
      <div className="card p-5 mt-6">
        ...
        <p className="text-sm text-slate-600">
          Patients must use therapy ≥ <strong>{t.minHoursPerNight} hours</strong> on at least{" "}
          <strong>{t.minNightsPercent}%</strong> of nights in any{" "}
          <strong>{t.windowDays}-day</strong> rolling window.
        </p>
        <p className="text-xs text-slate-500 mt-2">
          Thresholds vary by payer or monitoring use case. Configure under Reports.
        </p>
      </div>
      ...
      <div className="card p-5 mt-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/monitor/patients" className="text-sm text-brand-600">
            View all patients
          </Link>
        </div>
